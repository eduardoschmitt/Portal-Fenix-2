...
CREATE TABLE `equipamentos` (
  ...
  `situacaoequip` varchar(180) DEFAULT NULL,
  `necessidade` varchar(45) DEFAULT NULL,
  ...
  `codrecebedoa` int(11) DEFAULT NULL,
  `codsoftwares` int(11) DEFAULT NULL,
  `codtransporte` int(11) DEFAULT NULL,
  `codstats` int(11) DEFAULT NULL,
  PRIMARY KEY (`cod`),
  KEY `fk_softwares_equipamentos` (`codsoftwares`),
  KEY `fk_recebedoa_equipamentos` (`codrecebedoa`),
  KEY `fk_transporte_equipamentos` (`codtransporte`),
